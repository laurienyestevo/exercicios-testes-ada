...
describe('UserController', () => {
    it('Deve retornar 200 e o id caso todos os campos do req.body forem validos', async () => {
      ...
      const createUserMock = jest.spyOn(UserService, 'createUser').mockResolvedValue({ id: '123' }) //o spyon é tipo um espiao que vai verificar quantas vezes a função foi chamada e quais argumentos foram passados
    ...
    it('should return status 500 and a default error message if an error occurs', async () => {
      ...
      const createUserMock = jest.spyOn(UserService, 'createUser').mockRejectedValue(new Error('Database error'))
...
it('Deve retornar o status 400 e uma mensagem de erro caso a senha for inválida', async () => {
  ...
  describe('changePassword', () => {
    it('should log a message and return status 200', () => {
      const req = {
